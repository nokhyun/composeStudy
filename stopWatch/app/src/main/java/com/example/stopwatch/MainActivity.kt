    ...
    Scaffold(
        ...
        Row(
            ...
            FloatingActionButton(
                ...
                Image(painter = painterResource(id = if (isRunning) R.drawable.baseline_pause_24 else R.drawable.baseline_play_arrow_24), contentDescription = "start/pause")
            }
...
class MainViewModel : ViewModel() {
    ...
    private val _lapTimes = mutableStateOf<MutableList<String>>(mutableListOf())
